...
>
  ...
  <Link href="/christmas-store" className={`text-red-700 whitespace-nowrap ${underlineHover}`}>
    CHRISTMAS STORE
  </Link>

  <Link href="/royal-collection" className={`whitespace-nowrap ${underlineHover}`}>
    THE ROYAL COLLECTION
    <span className="text-xs bg-red-700 text-white px-1 ml-1">NEW</span>
  </Link>

  <Link href="/discovery-set" className={`whitespace-nowrap ${underlineHover}`}>
    DISCOVERY SET
  </Link>

  <Link href="/byob" className={`whitespace-nowrap ${underlineHover}`}>BYOB</Link>
